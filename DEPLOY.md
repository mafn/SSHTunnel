...
# Create /etc/ssh-tunnel/server.env
...
# Install service
sudo cp server/ssh-tunnel-server.service /etc/systemd/system/
...
sudo cp client/ssh-tunnel-client.container /etc/containers/systemd/
sudo systemctl daemon-reload
